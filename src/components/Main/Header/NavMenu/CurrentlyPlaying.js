        ...
        return (<>
            <div style={{ background: `rgba(${color[0].toString()})` }}>
                <div style={{ background: `rgba(${color[0].toString()})`, display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '150px 0' }}>
                    <span style={{ color: `rgba(${color[3].toString()})` }}><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-music-note-beamed" viewBox="0 0 16 16">
                        <path d="M6 13c0 1.105-1.12 2-2.5 2S1 14.105 1 13s1.12-2 2.5-2 2.5.896 2.5 2m9-2c0 1.105-1.12 2-2.5 2s-2.5-.895-2.5-2 1.12-2 2.5-2 2.5.895 2.5 2" />
                        <path fill-rule="evenodd" d="M14 11V2h1v9zM6 3v10H5V3z" />
                        <path d="M5 2.905a1 1 0 0 1 .9-.995l8-.8a1 1 0 0 1 1.1.995V3L5 4z" />
                    </svg></span>
                    <span style={{ color: `rgba(${color[4].toString()})` }}><svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-speaker" viewBox="0 0 16 16">
                    ...
                    <span style={{ color: `rgba(${color[1].toString()})` }}> <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-music-note" viewBox="0 0 16 16">
                        <path d="M9 13c0 1.105-1.12 2-2.5 2S4 14.105 4 13s1.12-2 2.5-2 2.5.895 2.5 2" />
                        <path fill-rule="evenodd" d="M9 3v10H8V3z" />
                        <path d="M8 2.82a1 1 0 0 1 .804-.98l3-.6A1 1 0 0 1 13 2.22V4L8 5z" />
                    </svg></span>
                </div>
                <span style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: "-110px" }} >Make sure you're playing spotify on a device!</span>
